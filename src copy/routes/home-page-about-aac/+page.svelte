...
<!-- This route was specifically created so that users who clicked on an "About AAC" link in the home page, would be redirected to a route/page with a back button, so that they would go back to their previous scroll position in the home-page after clicking the link/route/page's back button  -->
...
<div class="views-container">
	...
	<main class="views-content n50-on-blue">
		<p>
			...
			are known as
			<span class="font-bold">Augmentative and Alternative Communication (AAC)</span>
		</p>
		<p>
		...
		<div>
			When you augment something, you add to it. Augmentative communication adds something to the
			communication (eg. sign-language, pictures or a letter board) to make it more understandable.
		</div>
		<p>
